...
<div class="carousel-content">
 <h2 class="font-color-white">Aradığınız Nitelikli Özel Derse Hemen Başlayın</h2>
<p class="font-color-white">Yalnızca Özel Ders Almakla Kalmayın, Öğrenci Takip Sistemimizle Ne Kadar Geliştiğinizi Öğrenin ve Deneme Sınavlarıyla Kendinizi Test Edin! </p>
...
<input class="search-box_search_input" placeholder="" required="required" type="search">
...
<button type="submit" class="search-box_search_button">Özel Ders Al!</button>
</form>
</div>
</div>
...
<div class="container">
<h3 class="text-center">Özel Ders Kategorileri</h3>
<div class="vertical-space-30"></div>
<p class="max-width">Ders almak istediğiniz dersin eğitmenlerine ulaşın
</p>
